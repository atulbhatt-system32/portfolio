        ...
        <div className="container relative z-30 mx-auto">
          ...
          >
            ...
            <div className="flex flex-col w-full mb-12">
              ...
              {/* Project One */}
              <FeaturedProjectCard
                title={"about.dealshare.in"}
                status={"Live"}
                description={`A modern, responsive, and SEO-optimized landing page for DealShare, built with Next.js and Tailwind CSS. It features a clean, professional design with smooth animations and a focus on user experience.`}
                float={`right-0`}
                flexDirection={`flex-col lg:flex-row-reverse`}
                imgWidth={"1366"}
                imgHeight={"666"}
                imgSrc={"/projects/dealshare.png"}
                liveLink={"https://about.dealshare.in/"}
                repoLink={null}
                stack={
                  <>
                    <Icon
              ...
              <div className="px-3 md:w-1/3">
                <div className="w-full p-5 mx-auto mb-6 font-light text-gray-800 bg-white border border-gray-200 rounded-lg">
                  <div className="flex items-center w-full mb-4">
                    ...
                    <div className="flex-grow pl-3">
                      <span className="text-sm font-bold text-gray-600 uppercase">CA Aryan Rai Bhardwaj</span>
                    </div>
                  </div>
                  <div className="w-full">
